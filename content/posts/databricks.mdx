...
---
> This blog is part of a research collaboration with Databricks. In a prior [Databricks blog](https://www.databricks.com/blog/are-llm-agents-good-join-order-optimization), we discussed how LLMs are highly effective at iteratively optimizing SQL join orderings. This blog is a followup exploring the details of the LLM thinking process.
>
...
Since relational databases were first introduced, automated query optimizers and practitioners have [struggled](https://www.vldb.org/pvldb/vol9/p204-leis.pdf) to find good join orderings for SQL queries. In the [earlier blog](https://www.databricks.com/blog/are-llm-agents-good-join-order-optimization) we explored the ability of LLMs to optimize the join order of SQL queries, which can be thought of as a form of [ADRS optimization](https://arxiv.org/abs/2510.06189) against the SQL DSL instead of a full programmatic language. In that blog we showed that LLMs had promising performance for join ordering compared to state of the art approaches.
