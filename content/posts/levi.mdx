...
![Figure 1: One expensive ADRS run for everyone (top) vs. cheap, bespoke optimization per deployment (bottom).](/blog/levi/adrs_bespoke_diagram.png)
...
![Figure 2: LEVI's architecture: diverse seeds initialize a CVT-MAP-Elites archive; smaller models handle most mutations; a frontier model injects paradigm shifts every K evaluations.](/blog/levi/levi_arch.png)

*Figure 2: LEVI's architecture: diverse seeds initialize a CVT-MAP-Elites archive; smaller models handle most mutations; a frontier model injects paradigm shifts every K evaluations.*
...
Try out LEVI yourself at: [github.com/ttanv/levi](https://github.com/ttanv/levi)!
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| [**GEPA**](https://gepa-ai.github.io/gepa/) | 71.9 | 96.6 | 70.2 | 67.7 | **87.4** | 62.2 | 51.4 | 67.7 |
| [**OpenEvolve**](https://github.com/algorithmicsuperintelligence/openevolve) | 70.6 | 92.9 | 62.0 | 72.5 | **87.4** | 66.7 | 42.5 | 70.0 |
| [**ShinkaEvolve**](https://github.com/SakanaAI/ShinkaEvolve) | 67.4 | 72.0 | 66.4 | 68.5 | **87.4** | 63.6 | 45.6 | 68.2 |
| [**LEVI**](https://github.com/ttanv/levi) | **76.5** | **100.0** | **74.6** | **78.3** | **87.4** | **72.4** | **51.7** | **71.1** |

*Table 1: ADRS benchmark scores (%). Bold indicates best per problem. LEVI achieves the highest score on every problem where improvement is possible.*

### Cost

![Figure 3: Per-problem cost: LEVI vs. cheapest reported baseline. Savings range from 1.5x to 6.7x. Over 100$ saved in total.](/blog/levi/levi_cost_comparison_chart_(1).png)

*Figure 3: Per-problem cost: LEVI vs. cheapest reported baseline. Savings range from 1.5x to 6.7x. Over 100$ saved in total.*
...
![Figure 4: Transaction Scheduling, controlled (Qwen3-30B, 750 evals, 3 seeds). LEVI hits 62 within 100 evals; neither baseline reaches that level at any point.](/blog/levi/txn_scheduling.png)

*Figure 4: Transaction Scheduling, controlled (Qwen3-30B, 750 evals, 3 seeds). LEVI hits 62 within 100 evals; neither baseline reaches that level at any point.*
...
![Figure 5: Can't Be Late, same controlled setup. LEVI reaches near-peak by eval 50, roughly 12x faster than OpenEvolve.](/blog/levi/cant_be_late.png)

*Figure 5: Can't Be Late, same controlled setup. LEVI reaches near-peak by eval 50, roughly 12x faster than OpenEvolve.*
