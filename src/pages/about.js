...
export default function About() {
  return (
    <section className="space-y-6 pb-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center gap-6 pt-2">
        <figure className="flex justify-center md:justify-start w-full md:w-auto">
          <img src="/ADRS.png" alt="ADRS Logo" className="w-56 h-56 md:w-80 md:h-80 object-contain" />
        </figure>
      ...
      <div className="space-y-4 pt-1">
        ...
        <div className="md:flex md:items-center md:gap-6 space-y-4 md:space-y-0">
            ...
            <div className="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-4">
              ...
              >
                ...
                <div className="leading-tight">
                  <div className="text-berkeleyBlue font-semibold text-base">arXiv</div>
              ...
              >
                ...
                <div className="leading-tight">
                  <div className="text-berkeleyBlue font-semibold text-base">GitHub</div>
      ...
      <div className="space-y-3 pt-1">
        ...
        <ul className="list-disc pl-6 text-primary/90 text-lg md:text-xl space-y-1">
          <li>Email us at <a className="text-accent underline" href="mailto:ucbskyadrs@gmail.com">ucbskyadrs@gmail.com</a>.</li>
          <li>Join us on <a className="text-accent underline" href="https://join.slack.com/t/adrs-global/shared_invite/zt-3fgme22n5-PKYyAc9aIeTyX5iSQTKIoA" target="_blank" rel="noopener noreferrer">Slack</a> and <a className="text-accent underline" href="https://discord.gg/4z7Yy3e4" target="_blank" rel="noopener noreferrer">Discord</a>.</li>
          <li>Follow us on <a className="text-accent underline" href="https://x.com/ai4research_ucb" target="_blank" rel="noopener noreferrer">X</a>.</li>
        </ul>
      </div>
    </section>
  );
